...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { contact_id_id: @phone.contact_id_id, phone: @phone.phone } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { contact_id_id: @phone.contact_id_id, phone: @phone.phone } }
